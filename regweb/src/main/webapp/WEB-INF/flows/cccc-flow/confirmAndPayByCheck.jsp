...
<div id="embeddedFlow"  class="span-18">
    ...
    <div id="content" >
        ...
        <br/>
        <p>
            感謝您註冊芝加哥華人基督徒大會2015！Thank you for registering for Chicago Chinese Christian Conference! 
        </p>
        <br/>
        <p class="MsoNormal" style="margin-bottom: 0.0001pt; line-height: normal;">
            <span lang="ZH-CN" style="font-size: 11pt; font-family: SimHei; color: blue;">
                <b>
                    谢谢您选择以支票付款。手續要在費用繳清後才完成，請在一星期內繳清費用${form.paymentCurrency} $${form.expense.totalRegistrationFee+form.expense.totalMealsFee}，否則報名資料將取消。5人以上集体报名，每人$30.支票抬头请写：CCCM，请在Memo中注明：CCCC2015，并请注明您的大会报名确认码ID ${form.formID}。请将支票寄至：
        ...
        <div align="center" id="footer">
            <p>
                <b>
                    <span style="font-size:11.0pt;">Be sure to visit <a onClick="window.open('http://cccm.ws', 'CCCC2014', 'height=500,width=700,menubar=yes,toolbar=yes,directories=yes,location=yes,resizable=yes,scrollbars=yes');" href="javascript:void(0)">http://cccm.ws</a> for all the latest updates for CCCC 2015.
                    </span>
                </b>
            </p>
        </div>
